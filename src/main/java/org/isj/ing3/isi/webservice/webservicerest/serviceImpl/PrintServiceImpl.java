...
public class PrintServiceImpl implements IPrintService {
    ...
    public void generateCarteEtudiant() throws Exception {
        ...
        generatePDF.genererCartesEtudiants("Ingenieur", "Informatique et systèmes d'information", 2020, 3);
    }
    ...
    public void generateAttestationReusite() throws Exception {
        ...
        generatePDF.genererAttestation(noteEnvois, "LIC 3", 2020, "2020-07-18", "Concepteur Développeur d’Applications pour l’Economie Numérique", "Licence Professionnelle", 3);
    }
    ...
    @Override
    public void generateFicheAbsences() throws Exception {
        DateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        generatePDF.genererFicheAbsence("LIC 3", 3, "Licence Professionnelle", 2020, simpleDateFormat.parse("2020-08-29 23:00:00"), simpleDateFormat.parse("2021-08-28 23:00:0"), "Semestre 1");
    }

    @Override
    public void generatePv() throws Exception {
        generatePDF.genererPv(2020,"Semestre 1","ING 3", "Ingenieur", "Informatique et systèmes d'information", true, 3);
    }

    @Override
    public void generateNotes() throws Exception {
        generatePDF.imprimerNotes(3, "Semestre 1","2020","Semestre 1", "Informatique et systèmes d'information", "CC", 2020, "ISI3165");
