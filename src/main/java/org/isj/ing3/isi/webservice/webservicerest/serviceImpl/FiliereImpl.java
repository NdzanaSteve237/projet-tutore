...
public class FiliereImpl implements IFiliere {
    ...
    @Override
    public List<Filiere> getFiliereByLibelleFiliere(String libelleFiliere) throws IsjException {
        return filiereRepository.retrouverFiliere(libelleFiliere).orElseThrow(() -> new IsjException(ErrorInfo.RESSOURCE_NOT_FOUND)) ;   }
}
